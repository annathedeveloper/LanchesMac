...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminLanchesReportController : Controller
    {
        ...
        private readonly RelatorioLancheService _relatorioLanchesService;

        public AdminLanchesReportController(IWebHostEnvironment webHostEnv,
            RelatorioLancheService relatorioLanchesService)
        {
        ...
        public async Task<ActionResult> LanchesCategoriaReport()
        {
            ...
            var lanches = HelperFastReport.GetTable(await _relatorioLanchesService.GetProdutosReport(), "ProdutosReport");
            var categorias = HelperFastReport.GetTable(await _relatorioLanchesService.GetCategoriasReport(), "CategoriasReport");

            webReport.Report.RegisterData(lanches, "ProdutosReport");
        ...
        public async Task<ActionResult> LanchesCategoriaPDF()
        {
            ...
            //return File(stream, "application/zip", "LancheCategoria.pdf");  - faz o download do pdf
            return new FileStreamResult(stream, "application/pdf"); // abre no navegador
        }
    }
}
