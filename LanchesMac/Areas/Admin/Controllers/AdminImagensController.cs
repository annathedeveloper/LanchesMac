...
namespace LanchesMac.Areas.Admin.Controllers
{
    ...
    public class AdminImagensController : Controller
    {
        ...
        public AdminImagensController(IWebHostEnvironment hostingEnviroment, IOptions<ConfigurationImagens> myConfig)
        {
        ...
        public async Task<IActionResult> UploadFiles(List<IFormFile> files)
        {
            ...
            if (files.Count > 10)
            {
                ViewData["Erro"] = "Erro: Quantidae de arquivos excedeu o limite";
                return View(ViewData);
            }
